...
type
  [attTabela('he.avaliacao_renal_he')]
  TAvaliacao_Renal_HE = class(TTabela)
    ...
    Fausente_tempo: string;
    Fobs_ostomias: string;
    Fconstipacao: integer;
    Fcaracteristica_diurese: string;
    ...
    procedure Setausente_tempo(const Value: string);
    ...
    procedure Setcolostomia_tipo(const Value: string);
    ...
    procedure Setfralda_tipo(const Value: string);
    ...
    procedure Setsvd(const Value: Integer);
    procedure Setsvd_fralda(const Value: integer);
    procedure Setcaracteristica_diurese(const Value: string);
    ...
    public
      ...
      property svd : Integer read Fsvd write Setsvd;
      property ausente_tempo : string read Fausente_tempo write Setausente_tempo;
      property fralda_tipo : string read Ffralda_tipo write Setfralda_tipo;
      ...
      property colostomia_tipo : string read Fcolostomia_tipo write Setcolostomia_tipo;
      ...
      property caracteristica_diurese : string read Fcaracteristica_diurese write Setcaracteristica_diurese;
  end;
...
procedure TAvaliacao_Renal_HE.Setausente_tempo(const Value: string);
begin
...
procedure TAvaliacao_Renal_HE.Setcaracteristica_diurese(const Value: string);
begin
  Fcaracteristica_diurese := Value;
end;
...
procedure TAvaliacao_Renal_HE.Setcolostomia_tipo(const Value: string);
begin
...
procedure TAvaliacao_Renal_HE.Setfralda_tipo(const Value: string);
begin
  Ffralda_tipo := Value;
end;
...
procedure TAvaliacao_Renal_HE.Setsvd(const Value: integer);
begin
  Fsvd := Value;
end;
