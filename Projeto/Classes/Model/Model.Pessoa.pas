...
type
  ...
  private
    ...
    procedure SetId_religiao(const Value: integer);
  ...
  public
    ...
    property Id_religiao : integer read FId_religiao write SetId_religiao;
  end;
...
procedure TPessoa.SetId_religiao(const Value: integer);
begin
  FId_religiao := Value;
end;
