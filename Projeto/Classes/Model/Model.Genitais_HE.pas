...
type
  ...
  TGenitais_HE = class(TTabela)
    ...
    procedure Setanal_fístulas(const Value: integer);
    ...
    public
      ...
      property anal_fistulas : integer read Fanal_fístulas write Setanal_fístulas;
...
procedure TGenitais_HE.Setanal_fístulas(const Value: integer);
begin
  Fanal_fístulas := Value;
end;
