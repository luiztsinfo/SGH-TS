...
type
  ...
  TExtremidades_HE = class(TTabela)
    ...
    procedure Setedema_mmii(const Value: string);
    ...
    procedure Setulceras_arteriais(const Value: string);
    procedure Setulceras_venosas(const Value: string);
    ...
    public
      ...
      property edema_mmii : string read Fedema_mmii write Setedema_mmii;
      property ulceras_venosas : string read Fulceras_venosas write Setulceras_venosas;
      property ulceras_arteriais : string read Fulceras_arteriais write Setulceras_arteriais;
...
procedure TExtremidades_HE.Setedema_mmii(const Value: string);
begin
  Fedema_mmii := Value;
end;
...
procedure TExtremidades_HE.Setulceras_arteriais(const Value: string);
begin
  Fulceras_arteriais := Value;
end;

procedure TExtremidades_HE.Setulceras_venosas(const Value: string);
begin
