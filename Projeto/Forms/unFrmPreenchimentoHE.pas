...
begin
  ...
  if (Result >= 6) and (Result <= 9) then
    lblEscalaBraden.Caption := '6 - 9 | Altíssimo Risco';
...
begin
  ...
  FControllerHE.FAlergia.Descricao := FControllerHE.RegistrosAlergias.FieldByName('descricao').AsString; // verificar se isso é util nessa parte
...
begin
  ...
  FControllerHE.FAntecedente.Descricao := FControllerHE.FRegistrosAntecedente.FieldByName('descricao').AsString; // verificar se isso é util nessa parte
...
begin
  ...
  FControllerHE.FAtividadeReligiosa.Descricao := FControllerHE.RegistrosAtividadesReligiosas.FieldByName('descricao').AsString; // verificar se isso é util nessa parte
...
begin
  ...
  FControllerHE.FCirurgia.Descricao := FControllerHE.RegistrosCirurgias.FieldByName('descricao').AsString; // verificar se isso é util nessa parte
...
begin
  ...
  FControllerHE.FDiagnostico_Enfermagem.Descricao := FControllerHE.RegistrosDiagnosticos.FieldByName('descricao').AsString; // verificar se isso é util nessa parte
...
begin
  ...
  FControllerHE.FPrescricaoEnfermagem.Descricao := FControllerHE.RegistrosPrescricoes.FieldByName('descricao').AsString; // verificar se isso é util nessa parte
