...
begin
  ...
  if mskNascimento.Text <> dtVAZIA then
    FControllerPaciente.Model.Nascimento  := StrToDate(mskNascimento.Text)
  else
    FControllerPaciente.Model.Nascimento := 0;
...
begin
  ...
  edtReligiao.Text    := FControllerPaciente.RetornaReligiaoPorID; // fazer o metodo para retornar religiao por id
  CbxSexo.ItemIndex   := FControllerPaciente.Model.Sexo;
  CbxCor.ItemIndex    := FControllerPaciente.Model.Cor;
  CbxEstadoCivil.ItemIndex := FControllerPaciente.Model.Estado_Civil;
  CbxEscolaridade.ItemIndex := FControllerPaciente.Model.Escolaridade;
end;
...
begin
  inherited;
  edtReligiao.Text := FControllerPaciente.FRegistrosReligiao.FieldByName('descricao').AsString;
